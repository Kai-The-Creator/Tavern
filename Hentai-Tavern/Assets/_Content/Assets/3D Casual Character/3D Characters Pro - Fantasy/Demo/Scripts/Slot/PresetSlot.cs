...
namespace Layer_lab._3D_Casual_Character.Fantasy
{
    public class PresetSlot : MonoBehaviour, IPointerClickHandler
    {
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            {
                Character.Instance.OnPreset.Invoke();
                Character.Instance.OnPartChanged.Invoke(item.Key, item.Value);
            }
        ...
        public async void TakePreset()
        {
            ...
            _itemList = Character.Instance.CurrentPartsTypeAndNameList();
            imageCharacter.sprite = UIControl.GetSprite($"Preset/{_index}");
